...
function Contact({ focus, setFocus }) {
  return (
    <footer className="pt-20 flex flex-col justify-center px-5 md:px-10 xl:px-0">
      <div className="max-w-6xl w-full mx-auto min-h-[35rem] md:min-h-[41rem]  rounded-3xl p-10 flex flex-col justify-center items-center gap-5 relative overflow-hidden ">
        <div className="z-10 bg-transparent flex flex-col items-center">
          <h2 className="text-center text-4xl md:text-6xl font-[700] mb-5">
            Talk to me!
          </h2>
          <p className="text-center text-xl md:text-2xl mb-10 max-w-md md:max-w-xl font-semibold text-zinc-700 ">
            I am actively searching and available for new opportunities. You can
            get in touch with me, and I will respond as quickly as possible.
          </p>
          <div className="shadow-xl rounded-3xl">
            <ButtonGradient
              ...
              className={"md:py-4 md:px-7 md:text-2xl text-xl py-3 px-4"}
            >
              Give me a hello
            </ButtonGradient>
          </div>
        </div>
        <div className="absolute opacity-80 top-0 left-0 w-full h-full ">
          <svg className="h-full w-full object-cover" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 1500">
            <rect fill="#C9DDFC" width="2000" height="1500" />
            <defs>
              <radialGradient id="a" gradientUnits="objectBoundingBox">
                <stop offset="0" stopColor="#EBEFFE" />
                <stop offset="1" stopColor="#C9DDFC" />
              </radialGradient>
              <linearGradient
                id="b"
                ...
                y2="750"
              >
                <stop offset="0" stopColor="#dae6fd" />
                <stop offset="1" stopColor="#C9DDFC" />
              </linearGradient>
              <path
                id="s"
        ...
        {/* <img className="absolute opacity-40 w-full h-full object-cover" src="./images/gradient_1.png" /> */}
      </div>
    </footer>
  );
}
